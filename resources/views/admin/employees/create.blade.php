...
@section('title', 'Add Employee - Sales CRM')
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-1">Create a new employee account to grant access to the system.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <form action="{{ route('admin.employees.store') }}" method="POST">
                ...
                <div class="bg-slate-50 px-6 py-4 border-t border-slate-100 flex items-center justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-colors shadow-sm shadow-blue-200">
                        Create Employee
                    </button>
                </div>
            </form>
