...
@section('title', 'Edit Customer - Sales CRM')
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-1">Update customer details and contact information.</p>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea id="address" name="address" rows="3"
                                    class="w-full px-4 py-2.5 bg-slate-50 border @error('address') border-rose-300 focus:border-rose-500 focus:ring-rose-200 @else border-slate-200 focus:border-blue-500 focus:ring-blue-200 @enderror rounded-xl text-sm focus:bg-white focus:ring-2 transition-all outline-none shadow-sm resize-y">{{ old('address', $customer->address) }}</textarea>
                                @error('address')
                                    <p class="text-xs text-rose-600 mt-1.5 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
